...
def draw_circle(screen, center, radius, baseLayer, color):
    screen.blit(baseLayer, (0, 0))
    pygame.draw.circle(screen, color, center, radius)

def draw_square(screen, prevX, prevY, currentX, currentY, baseLayer, color):
    screen.blit(baseLayer, (0, 0))
    ...
    while True:
        ...
        if isMouseDown and prevX != -1 and prevY != -1 and currentX != -1 and currentY != -1:
            if mode == 'pencil':
                ...
                draw_circle(screen, prevX, prevY, currentX, currentY, baseLayer, color)
            elif mode == 'erase':
